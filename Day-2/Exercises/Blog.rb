...
blog.add_post Post.new("Post 2", Date.new(2015, 04, 04), "This is the body of the post 2.")
...
blog.add_post Post.new("Post 6", Date.new(2015, 01, 25), "This is the body of the post 6.")
...
blog.add_post Post.new("Post 9", Date.new(2015, 11, 10), "This is the body of the post 9.")
